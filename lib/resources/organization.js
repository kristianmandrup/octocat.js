...
var Organization = function (_Resource) {
    ...
    function Organization(client, github, clientID) {
        _classCallCheck(this, Organization);

        var _this = _possibleConstructorReturn(this, (Organization.__proto__ || Object.getPrototypeOf(Organization)).call(this, client, {
            preview: true
        }));
