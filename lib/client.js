...
var APIClient = function (_Loggable) {
    _inherits(APIClient, _Loggable);
    ...
    function APIClient() {
        ...
        var _this = _possibleConstructorReturn(this, (APIClient.__proto__ || Object.getPrototypeOf(APIClient)).call(this, 'APIClient', options));
